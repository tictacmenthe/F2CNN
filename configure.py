...
classes = input('How many input labels should there be? \n\t\t2:rising and falling\n\t\t3:falling, rising, none)\nChoice:(default 2)') or '2'
inputRadius = input('Enter the CNN input radius(frames used will be between i+-radius*samplitperiod of .FB files) in ms(default 5):') or '5'
